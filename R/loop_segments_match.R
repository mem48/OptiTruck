...
loop = readRDS("data/incidents/M62/webtris/sites.Rds")
loop_data = readRDS("data/incidents/M62/webtris/traffic_counts.Rds")
...
loop = loop[loop$direction == "Eastbound",]
...
write.csv(loop_data_sub,"data/incidents/M62/webtris/traffic_counts_matched.csv")
saveRDS(loop_data_sub,"data/incidents/M62/webtris/traffic_counts_matched.Rds")
write_sf(segments,"data/incidents/M62/clean/segments_matched.geojson", delete_dsn = T)
